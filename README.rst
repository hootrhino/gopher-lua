...
.. image:: https://pkg.go.dev/badge/github.com/i4de/gopher-lua.svg
    :target: https://pkg.go.dev/github.com/i4de/gopher-lua

.. image:: https://github.com/i4de/gopher-lua/workflows/test/badge.svg?branch=master&event=push
    :target: https://github.com/i4de/gopher-lua/actions?query=workflow:test
...
There are some benchmarks on the `wiki page <https://github.com/i4de/gopher-lua/wiki/Benchmarks>`_ .
...
.. code-block:: bash
   ...
   go get github.com/i4de/gopher-lua
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/i4de/gopher-lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/i4de/gopher-lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/i4de/gopher-lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/i4de/gopher-lua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/i4de/gopher-lua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/i4de/gopher-lua/tree/master/.github/CONTRIBUTING.md>`_ .
